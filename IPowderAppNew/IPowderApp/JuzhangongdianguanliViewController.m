//
//  JuzhangongdianguanliViewController.m
//  i动力
//
...
@implementation JuzhangongdianguanliViewController
...
-(void)getLevelData{
    ...
    [XIYI_MBProgressHUD showHUDAddedTo:self.view.window animated:YES];
        ...
        [service getPRServiceLevelDataWithAccessToken:AccessToken operationTime:[PowerUtils getOperationTime:@"yyyy-MM-dd-HH:mm:ss"] regNum:_regNO ObjTypeNum:@"1" completeBlock:block loadingView:self.view showHUD:YES];
}
