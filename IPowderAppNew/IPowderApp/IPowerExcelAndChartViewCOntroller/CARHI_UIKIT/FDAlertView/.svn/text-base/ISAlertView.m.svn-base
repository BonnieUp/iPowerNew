...
- (void)customIOS7dialogButtonTouchUpInside:(UIButton*)button
{
    if (delegate != NULL) {
...
- (void)keyboardWillShow: (NSNotification *)notification
{
    ...
    [UIView animateWithDuration:0.2f delay:0.0 options:UIViewAnimationOptionTransitionNone
                     animations:^{
                         dialogView.frame = CGRectMake((screenSize.width - dialogSize.width) / 2, (screenSize.height - keyboardSize.height - dialogSize.height) / 2-30, dialogSize.width, dialogSize.height);
                     }
                     completion:nil
     ];
}
