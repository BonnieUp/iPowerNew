...
@interface LishigaojingViewController ()

@end

@implementation LishigaojingViewController {
...
//    [self getLishigaojingWithRegNum:@"" StationNum:@"" StationName:@"" AlarmLevelNum:@"" DevClassNum:@"" AlarmDescript:@"" WX_FullNo:@"" pageIndex:[NSString stringWithFormat:@"%li",currentIndex] StartTime:@"" StopTime:@"" showHUD:YES];
}

-(void)viewDidAppear:(BOOL)animated {
    [super viewDidAppear:animated];
//    if( isComplete==NO ) {
//        [self getLishigaojingWithRegNum:@"" StationNum:@"" StationName:@"" AlarmLevelNum:@"" DevClassNum:@"" AlarmDescript:@"" WX_FullNo:@"" pageIndex:[NSString stringWithFormat:@"%i",currentIndex] StartTime:@"" StopTime:@"" showHUD:YES];
//        isComplete = YES;
//    }
    [self getLishigaojingWithRegNum:@"" StationNum:@"" StationName:@"" AlarmLevelNum:@"" DevClassNum:@"" AlarmDescript:@"" WX_FullNo:@"" pageIndex:[NSString stringWithFormat:@"%li",(long)currentIndex] StartTime:@"" StopTime:@"" showHUD:YES];
}
...
-(void)goToNextPage {
    currentIndex++;
    if(searchDic==nil) {
        [self getLishigaojingWithRegNum:@"" StationNum:@"" StationName:@"" AlarmLevelNum:@"" DevClassNum:@"" AlarmDescript:@"" WX_FullNo:@"" pageIndex:[NSString stringWithFormat:@"%li",(long)currentIndex] StartTime:@"" StopTime:@"" showHUD:NO];
    }else {
        [self getLishigaojingWithRegNum:[searchDic objectForKey:@"qujv"] StationNum:@"" StationName:[searchDic objectForKey:@"jvzhan"] AlarmLevelNum:[searchDic objectForKey:@"gaojingdengji"] DevClassNum:[searchDic objectForKey:@"shebeidalei"] AlarmDescript:[searchDic objectForKey:@"gaojingyuanyin"] WX_FullNo:@"" pageIndex:[NSString stringWithFormat:@"%li",(long)currentIndex] StartTime:[searchDic objectForKey:@"kaishishijian"] StopTime:[searchDic objectForKey:@"jiesushijian"] showHUD:NO];
    }
...
-(void)getLishigaojingWithRegNum:(NSString *)RegNum
    ...
    RequestCompleteBlock block = ^(id result) {
        ...
        searchBar.text = @"";
        [self closeKeyboard];
        if(_delegate && [_delegate respondsToSelector:@selector(setLishigaojingAmount:)]) {
            
            if([result objectForKey:@"ROWCOUNT"]!=nil){
                [_delegate setLishigaojingAmount:[result objectForKey:@"ROWCOUNT"]];
            }
        }
    };
    [dataService getHistoryAlarmDataWithAccessToken:AccessToken operationTime:[PowerUtils getOperationTime:@"yyyy-MM-dd-HH:mm:ss"] regNum:RegNum stationNum:StationNum stationName:StationName alarmLevelNum:AlarmLevelNum devClassNum:DevClassNum alarmDescript:AlarmDescript wXFullNo:WX_FullNo pageIndex:pageIndex startTime:[PowerUtils getLastMonthDay:@"yyyy-MM-dd-HH:mm:ss"] stopTime:[PowerUtils getOperationTime:@"yyyy-MM-dd-HH:mm:ss"] completeBlock:block loadingView:gaojingTable showHUD:showHUD];
}
