//
//  JifanggongdianguanliViewController.m
//  i动力
//
...
@implementation JifanggongdianguanliViewController
...
-(void)getLevelData{
    ...
    [service getPRServiceLevelDataWithAccessToken:AccessToken operationTime:[PowerUtils getOperationTime:@"yyyy-MM-dd-HH:mm:ss"] regNum:_regNO ObjTypeNum:@"2" completeBlock:block loadingView:self.view showHUD:YES];
}
