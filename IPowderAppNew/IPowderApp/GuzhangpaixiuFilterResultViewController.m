//
//  GuzhangpaixiuFilterResultViewController.m
//  IPowerApp
//
...
@interface GuzhangpaixiuFilterResultViewController ()

@end

@implementation GuzhangpaixiuFilterResultViewController {
...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    if (self) {
        ...
        [self setTitleWithPosition:@"center" title:@"故障派修"];
...
- (void)viewDidLoad
{
    ...
    guzhangTable = [[UITableView alloc]initWithFrame:CGRectMake(0,45, ScreenWidth, ScreenHeight-NAVIGATION_BAR_HEIGHT-STATUS_BAR_HEIGHT-45)];
