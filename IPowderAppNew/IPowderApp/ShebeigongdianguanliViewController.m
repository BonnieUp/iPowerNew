//
//  ShebeigongdianguanliViewController.m
//  i动力
//
...
@implementation ShebeigongdianguanliViewController
...
-(void)getLevelData{
    ...
    [service getPRServiceLevelDataWithAccessToken:AccessToken operationTime:[PowerUtils getOperationTime:@"yyyy-MM-dd-HH:mm:ss"] regNum:_regNO ObjTypeNum:@"4" completeBlock:block loadingView:self.view showHUD:YES];
}
