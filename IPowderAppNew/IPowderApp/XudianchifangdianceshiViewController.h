//
//  XudianchifangdianceshiViewController.h
//  i动力
//
...
@protocol XudianchifangdianDelegate <NSObject>

-(void)popFangdianFilterConditionController;

@end

@interface XudianchifangdianceshiViewController : BaseViewController<UITableViewDataSource,UITableViewDelegate,EGORefreshTableDelegate>{
    //存放测试信息table
...
@property (nonatomic,strong) id<XudianchifangdianDelegate> delegate;
